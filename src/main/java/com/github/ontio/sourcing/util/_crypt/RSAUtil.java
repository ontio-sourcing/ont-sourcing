package com.github.ontio.sourcing.util._crypt;
...
public class RSAUtil {
     ...
     * @throws Exception
     */
    public String encrypt2Base64ByPublicKey(String data) throws Exception {
        byte[] dataByte = data.getBytes();
        byte[] keyBytes = Base64ConvertUtil.decodeAndReturnBytes(public_key);
        X509EncodedKeySpec x509KeySpec = new X509EncodedKeySpec(keyBytes);
        KeyFactory keyFactory = KeyFactory.getInstance(KEY_ALGORITHM);
     ...
     * @throws Exception
     */
    public byte[] decrypt2ByteByPrivateKey(String data) throws Exception {
        byte[] encryptedData = Base64ConvertUtil.decodeAndReturnBytes(data);
        byte[] keyBytes = Base64ConvertUtil.decodeAndReturnBytes(private_key);
        PKCS8EncodedKeySpec pkcs8KeySpec = new PKCS8EncodedKeySpec(keyBytes);
        KeyFactory keyFactory = KeyFactory.getInstance(KEY_ALGORITHM);
     ...
     * @throws Exception
     */
    public String decrypt2StrByPrivateKey(String data) throws Exception {
        byte[] encryptedData = Base64ConvertUtil.decodeAndReturnBytes(data);
        byte[] keyBytes = Base64ConvertUtil.decodeAndReturnBytes(private_key);
        PKCS8EncodedKeySpec pkcs8KeySpec = new PKCS8EncodedKeySpec(keyBytes);
        KeyFactory keyFactory = KeyFactory.getInstance(KEY_ALGORITHM);
